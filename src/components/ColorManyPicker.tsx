...
function IconColor ({ sx, ...other }:{ sx : any, [x : string] : any}) {
  return (
    <Box
      sx={{
        width: 20,
...
export default function ColorManyPicker ({ colors, onChecked, sx, ...other }: { colors : any, onChecked : any, sx : any, [x: string] : any}) {
  return (
    <Box sx={sx}>
